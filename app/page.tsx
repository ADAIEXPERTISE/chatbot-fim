...
//               <div>
//                 <p className="text-sm text-gray-600">Nom de l&apos;éxposant</p>
...
//                   <div>
//                     <p className="text-sm text-gray-600">Numéro de stand </p>
//                     <p className="text-base font-semibold text-gray-900">
//                       {selectedExhibitorForModal.standCode}
//                     </p>
//                   </div>
...
//                 <button
//                   onClick={handleCloseExhibitorModal}
//                   className="flex-1 rounded-lg border border-zinc-800 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
//                 >
//                   Fermer
//                 </button>
//               </div>
...
export default function ChatBox() {
  ...
  const [currentAI, setCurrentAI] = useState<AgentCardProps | null>({
    ...
    description:
      "Tri intelligent des e‑mails, synthèse des réunions, préparation des réponses, priorisation des actions, agenda augmenté.",
    imageUrl: "/image/lucid-origin_A_futuristic_AI_presence_non-physical_form._Abstract_energy_shape_subtle_glowing-3.jpg",
    color: "shadow-green-500",
  });
